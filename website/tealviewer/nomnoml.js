    ...
    function parse(source) {
        ...
        function getConfig(d) {
            ...
            return {
                ...
                bendSize: +d.bendSize || 1,
                direction: directionToDagre(d.direction),
                gutter: +d.gutter || 5,
                edgeMargin: (+d.edgeMargin) || 0,
                edges: d.edges == 'hard' ? 'hard' : 'rounded',
                fill: (d.fill || '#f2f2f2;#fdf6e3;#f2f2f2;#fdf6e3').split(';'),
                fillArrows: d.fillArrows === 'true',
                font: d.font || 'Calibri',
                fontSize: (+d.fontSize) || 12,
                leading: (+d.leading) || 1.3,
...
(function (nomnoml) {
    ...
    nomnoml.visualizers = {
        ...
        "class": function (node, x, y, config, g) {
            g.rect(x, y, node.width, node.height, node.name, "node rect-node").fillAndStroke();
        },
