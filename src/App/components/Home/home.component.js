                    ...
                    <Grid container spacing={3}>
                        ...
                        <Grid item xs={12} sm={width} md={width} xl={width}>
                            <div className='app-wrapper'>
                                <div className={'app-container ' + classes.primaryBackColor}>
                                    <div className='app-title'>
                                        <AppsIcon className={classes.appIcon}></AppsIcon> App Manager
                                    </div>
                        ...
                        <Grid item xs={12} sm={width} md={width} xl={width}>
                            <div className='app-wrapper'>
                                <div className={'app-container ' + classes.primaryBackColor}>
                                    <div className='app-title'>
                                        <AccountBalanceWalletIcon className={classes.appIcon}></AccountBalanceWalletIcon>Asset Manager
                                    </div>
                                    <div>
                                        <Button variant="text"
                                                className="open-button"
                        ...
                        <Grid item xs={12} sm={width} md={width} xl={width}>
                            <div className='app-wrapper'>
                                <div className={'app-container ' + classes.primaryBackColor}>
                                    <div className='app-title'>
                                        <SubjectIcon className={classes.appIcon}></SubjectIcon>TEAL Editor
                                    </div>
                                    <div>
                                        <Button variant="text"
                                                className="open-button"
                        ...
                        <Grid item xs={12} sm={width} md={width} xl={width}>
                            <div className='app-wrapper'>
                                <div className={'app-container ' + classes.primaryBackColor}>
                                    <div className='app-title'>
                                        <AccountBalanceWalletIcon className={classes.appIcon}></AccountBalanceWalletIcon>Web Wallet
                                    </div>
                                    <div>
                                        <Button variant="text"
                                                className="open-button"
                        ...
                        {/*    <div className='app-wrapper'>*/}
                        {/*        <div className={'app-container ' + classes.primaryBackColor}>*/}
                        {/*            <div className='app-title'>Web Wallet</div>*/}
                        {/*        </div>*/}
                        {/*    </div>*/}
                        {/*</Grid>*/}
